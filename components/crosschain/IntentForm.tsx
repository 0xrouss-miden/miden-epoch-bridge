  ...
  return (
    <div className="ui-card">
      ...
      <p className="mt-2 text-sm leading-relaxed text-neutral-600">
        Choose the asset and the minimum amount to receive. Review the required amount before authorizing collateral.
      </p>
      ...
      <div className="mt-4 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <Label>Destination token ({chainId === DEFAULT_SEPOLIA_CHAIN_ID_STR ? 'Sepolia' : 'destination chain'})</Label>
            <SelectRoot
              value={outputToken}
              onValueChange={(v) => {
                setOutputToken(v);
            ...
            >
              <SelectTrigger aria-label="Select destination token">
          ...
          <div>
            <Label htmlFor="intent-min-out">Minimum to receive (base units)</Label>
            <Input
              id="intent-min-out"
              value={minTokenOut}
        ...
        {pendingQuote && (
          <div className="rounded-xl border border-primary/30 bg-primary/5 p-4 space-y-3">
            ...
            <p className="text-xs text-neutral-500 italic">You need this amount in your Miden wallet to confirm.</p>
          </div>
        )}
        ...
        {!pendingQuote ? (
          ...
          >
            {isConfirmBusy ? 'Processing…' : 'Confirm and sign'}
          </Button>
        )}
